...
% Init fuzzy controllers
deg = readfis('FUZZY_deg_neurospora_model_leloup.fis');
tsc = readfis('FUZZY_tsc_neurospora_model_leloup.fis');
tsl = readfis('FUZZY_tsl_neurospora_model_leloup.fis');
